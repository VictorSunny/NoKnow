...
class UserCache(BaseModel):
    ...
    def validate_values(cls, data: Any):
        if isinstance(data, dict):
            ...
            is_two_factor_authenticated_is_valid = is_bool(variable=data.get("is_two_factor_authenticated"))
            ...
            if not is_two_factor_authenticated_is_valid:
                raise Exception("user cache is_two_factor_authenticated value is not a valid boolean")
        return data
    ...
    def modify_fields(self):
        ...
        self.is_two_factor_authenticated = str_to_bool(variable=self.is_two_factor_authenticated)
